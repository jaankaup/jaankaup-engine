struct McParams {
    ...
    noise_global_dimension: vec3<u32>, // no longer noise 
    noise_local_dimension: vec3<u32>, // no longer noise 
};
...
@group(0) @binding(3)
var<storage, read> fmm_values: array<FmmCellPc>;
...
fn calculate_density(v: vec3<i32>) -> f32 {
    ...
    return fmm_values[global_index + local_index].value; 
}
